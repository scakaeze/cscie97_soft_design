...
public class CMDAPI {
	...
	/**
     * cmdSort - evaluates command "s" and determines which  API command (define, set or get) should process the command
     *         - Then it sends command "s" to the corresponding API command
     * @param v
     */
	
	public void cmdSort(String s) throws Exception{
		...
		default:
			status = "CommandException: (" + s + ") is an invalid command";

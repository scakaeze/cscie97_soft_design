	...
	public String define(String command) throws Exception{
		...
		case "house": 
			...
			{		
				...
				status = "CommandException: The house already exists or (" + command + ") is invalid command";
		...
		case "room":
			...
			status = "";
				...
				status = "CommandException: The room already exists or (" + command + ") is an invalid command";
				throw new Exception(status);
				}
		...
		case "occupant":
			...
			status = "";
				...
				status = "CommandException: The occupant already exists or (" + command + ") is an invalid command";
				throw new Exception(status);
				}
		...
		case "sensor":
			if (!(ModelService.getInstance().sensorExists(element[2], element[6]))){
				...
				status = "CommandException: The sensor already exists or (" + command + ") is an invalid command";
				throw new Exception(status);
				}
		...
		case "appliance":
			if (!(ModelService.getInstance().applianceExists(element[2], element[6]))){
				...
				status = "CommandException: The appliance already exists or (" + command + ") is an invalid command";
				throw new Exception(status);
				}
